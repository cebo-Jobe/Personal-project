...
public class Graph<T extends Comparable<T>> implements Serializable{
    ...
    private static final long serialVersionUID = 2405003476061465450L;
    ...
    public static class Vertex<T extends Comparable<T>> implements Serializable, Comparable<Vertex<T>> {

        private static final long serialVersionUID = -4188431120353524400L;
    ...
    public static class Edge<T extends Comparable<T>> implements Serializable, Comparable<Edge<T>> {

        private static final long serialVersionUID = -1955022226273664138L;
